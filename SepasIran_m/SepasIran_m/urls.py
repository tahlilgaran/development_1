...
urlpatterns = [
    ...
    url(r'tourdefine/tour/2/(\w+)$','define_trip.views.tour_define_2'),
    url(r'tourdefine/tour/change/(\w+)$','define_trip.views.tour_define'),
    url(r'tourdefine/airplane/$','define_trip.views.airplane_define'),
    url(r'tourdefine/airplane/2/(\w+)$','define_trip.views.airplane_define_2'),
    url(r'tourdefine/train/$','define_trip.views.train_define'),
    url(r'tourdefine/train/2/(\w+)/$','define_trip.views.train_define_2'),
    url(r'tourdefine/hotel/$','define_trip.views.hotel_define'),
    url(r'tourdefine/hotel/2/(\w+)/$','define_trip.views.hotel_define_2'),
    url(r'tourdefine/restaurant/$','define_trip.views.restaurant_define'),
    url(r'tourdefine/restaurant/2/(\w+)/$','define_trip.views.restaurant_define_2'),
